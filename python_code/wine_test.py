...
try:
	...
	print("-----------------------------------------------------------------")
	print("$sudo docker run -v <host-folder-path>:/job umang0812/winetest:latest <Name of csv file> ")
	print("-----------------------------------------------------------------")
...
try:
	...
	print("Pass parameters as: ")
	print("-----------------------------------------------------------------")
	print("$sudo docker run -v <host-folder-path>:/job umang0812/winetest:latest TestDataset.csv ")
	print("-----------------------------------------------------------------")
	print("--> Make sure that the <host-folder-path> contains the CSV as well as Model file for prediction")
	print("***********************************************************************")
	exit()
